<?php
  function crc32making_settings($mArray)
  {
    $cont = '';
    ...
    $cont .= "<form action='".$SERVER['script_name']."' method='POST'>";
      ...
      $cont .= "<tr><td>&nbsp;</td><td style='".$tableCellStyle."'>Заголовок таблицы</td><td style='".$tableCellStyle."'>Заголовок поля</td></tr>";
  ...
  function crc32making_save_settings($mArray)
  {
  ...
  function crc32making_update_data($fieldName, $params)
  {
    if (@$_POST[$fieldName] != '')
    {
      $_POST[$fieldName] = crc32($_POST[$fieldName]);
    }
  }
?>
